...
VOID RecordMemAccess(THREADID tid,VOID *addr,UINT32 Ref_Size)
{
...
VOID RecordMem(THREADID tid,VOID * addr,UINT32 ReferenceSize)
{
	PIN_GetLock(&pinLock, tid+1);
	RecordMemAccess(tid,addr,ReferenceSize);
	PIN_ReleaseLock(&pinLock);
}
